...
SVC_NAME="actions.runner.sangkhung1011-dotcom-devops-practice.sever.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (sangkhung1011-dotcom-devops-practice.sever)"
